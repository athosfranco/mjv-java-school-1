...
public class GeradorMensagem {
	public void gerar(Contrato contrato) {
		...
		String cpfFormatado = FormatadorUtil.formatarCpf(contrato.getCliente().getCpf());
		...
		String servico = contrato.getServico();
		String valor = FormatadorUtil.formatarValor(contrato.getValor());
		String cep = FormatadorUtil.formatarCep(contrato.getCliente().getEndereco().getCep());
		...
		sb.append("Cidade:"+contrato.getCliente().getEndereco().getCidade()+"/"+contrato.getCliente().getEndereco().getEstado()+"\n");
		sb.append("Cep:"+cep);
